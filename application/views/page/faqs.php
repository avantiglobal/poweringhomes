			...
			<div class="col">
				<div class="accordion accordion-flush" id="accordionFlushExample">
					...
					<div class="accordion-item">
						...
						<div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
							<div class="accordion-body text-start">
								...
								<p>
									25 years on the panels, 12 to 30 years on the inverter, 10 years on the workmanship warranty. Truly, we've got you covered when it comes to protecting your solar investment and making sure that it provides value to you for the long.
								</p>
							</div>
						</div>
					</div>
					...
					<div class="accordion-item">
						...
						<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse-5" aria-expanded="false" aria-controls="flush-collapseThree">
						...
						<div id="flush-collapse-5" class="accordion-collapse collapse" aria-labelledby="flush-heading-5" data-bs-parent="#accordionFlushExample">
							<div class="accordion-body text-start">
								<p>
									<b>Not every home is eligible for solar, so cross your fingers.</b> Let's hope you're one of the lucky ones, and you can save money. There are three main factors:
								</p>
								<ol>
									<li>
					...
					<div class="accordion-item">
						...
						<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse-6" aria-expanded="false" aria-controls="flush-collapseThree">
						...
						<div id="flush-collapse-6" class="accordion-collapse collapse" aria-labelledby="flush-heading-6" data-bs-parent="#accordionFlushExample">
							<div class="accordion-body text-start">
								...
								<p>
									We will help you figure out what is best for you. When you get a proposal from us, our consultants are going to sit down with you. They're going to show you all the different options and help you decide what's best for you. They're going to show you how much money you can save with Powering Homes and we're going to make it as easy as humanly possible for you to understand and make your decision.
								</p>
							</div>
						</div>
					</div>
					<div class="accordion-item">
						...
						<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse-7" aria-expanded="false" aria-controls="flush-collapseThree">
					...
					<div class="accordion-item">
						...
						<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse-8" aria-expanded="false" aria-controls="flush-collapseThree">
					...
					<div class="accordion-item">
						...
						<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse-9" aria-expanded="false" aria-controls="flush-collapseThree">
						...
						<div id="flush-collapse-9" class="accordion-collapse collapse" aria-labelledby="flush-heading-9" data-bs-parent="#accordionFlushExample">
							<div class="accordion-body text-start">
								...
								<p>
									That's where you can get to with solar versus being stuck in a lifelong, expensive contract forever with a company that you probably don't even really like. To be honest, do you like your utility company? Do you feel like they're taking care of you? Do they have your back? Well, I can tell you that our sincere aim is to serve you.
								</p>
								<p>
									We want to be a better energy provider. We want to save you money. We want to help you feel proud of how you power your home. And we want to get you all the best equipment, the best technology to set you up for the future. So those are your two options. And I leave it to you to choose. But I truly and sincerely hope that you go solar with Powering Homes. 
								</p>
								<h4>
									Let us help you save money and accelerate a sustainable energy future for mankind.
								</h4>
							</div>
						</div>
					</div>
