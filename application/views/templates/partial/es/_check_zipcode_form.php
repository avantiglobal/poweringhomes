<form class="zipcode-checker-form" name="zipcode-checker-form__header">
    <div class="d-flex flex-row">
        <input class="form-control me-2" id="zipcode-checker-form__header__input" type="search" placeholder="Codigo Postal" aria-label="Código Postal" maxlength="5" required>
        <button class="btn btn-primary btn-primary--130" type="submit">Aplicar</button>
